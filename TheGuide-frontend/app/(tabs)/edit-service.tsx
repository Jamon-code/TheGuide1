...
export default function EditServiceScreen() {
  ...
  useEffect(() => {
    // ✅ récupérer le service réel
    const service = services.find((s: any) => s.id === id);

    if (service) {
      setName(service.name);
      setImageUrl(service.image);
      setSelectedType(service.typeName || service.type);

      const chars = Object.entries(service.characteristics || {}).map(
...
const handleUpdate = () => {
  ...
  // redirect
  router.push('/(tabs)/my-activities');
};
      ...
      >
        ...
        <TouchableWithoutFeedback onPress={handleUpdate}>
          <View style={styles.saveButton}>
            ...
            <ThemedText style={styles.saveButtonText}>Modifier le service</ThemedText>
          </View>
        </TouchableWithoutFeedback>
